...
void Sun::setLoc(double longitude, double latitude) {
  this->lon = longitude;
  this->lat = latitude;
}

void Sun::setTime(int year, int month, int date,
...
void Sun::calcPos() {
              ...
              int month = this->mon;
              int day = this->day;
              double hours = this->hr;
              double minutes = this->min;
              double seconds = this->sec;
